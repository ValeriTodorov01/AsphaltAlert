const Footer = () => {
	return (
		<footer className="font-semibold text-[#344050] mt-12 mb-20 w-[92%] justify-self-center">
			...
			<div className="flex flex-wrap md:flex-nowrap justify-between">
				<p className="flex text-[20px]">
					Discover and report road dangers in your area with our
					interactive map.
				</p>
